    ...
    <nav className='montserrat m-auto flex max-w-screen-2xl justify-between p-5 md:py-5 md:px-10 xl:py-5 xl:px-11 bg-[#004733]'>
        <div className='flex flex-row'>
            <ul className='flex items-center'>
                <li className='mr-2'>
                    <a className="font-normal transition-all ease-in-out duration-300 group-hover:bg-backgroundSecondary group-hover:text-white text-white hover:text-blck hover:bg-inherit" href="/">
                        <svg role="img" className=" fill-white" width="65px" height="20px" viewBox="0 0 495 133" version="1.1" xmlns="http://www.w3.org/2000/svg"><title>Better</title>
